...
export const AddDelivery = () => {
    ...
    const addDelivery = async (event: { preventDefault: () => void }) => {
        event.preventDefault();
        try {
            await axios.post(`${BACKEND_API_URL}delivs/`, delivery, {
                headers: {
                    ...
                    <form onSubmit={addDelivery}>
                        ...
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                            <DatePicker
                                ...
                                onChange={(event) => setDelivery({...delivery, date: String(JSON.stringify(event).slice(1, 11))})}
                            />
